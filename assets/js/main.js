...
$(".backround_game").on("click",".btn_playgame",function(){
    $(".backround_game").addClass("hide_game")
})

$("#full-game").on("click",".btn_playgame",function(){
    $(".backround_game ").addClass("hide_game")
    // $(".loading_game").removeClass("hide")
    let urlIframe = $("#full-game").attr("data-embed");
    // create iframe
    var iframe = document.createElement("iframe");
        ...
        iframe.setAttribute("class", "game-iframe w-[100%] h-[100%]");
        $("#full-game").append(iframe)
